-- Resume Analyzer Database Schema - Clean Migration
...
BEGIN
  ...
  SELECT EXISTS (
    ...
    AND constraint_name = 'xxpj_subscriptions_user_id_key'
  ...
  SELECT EXISTS (
    SELECT 1 FROM information_schema.table_constraints 
    WHERE table_name = 'xxpj_subscriptions' 
    AND constraint_name = 'xxpj_subscriptions_stripe_customer_id_key'
  ) INTO constraint_exists;
  ...
  SELECT EXISTS (
    SELECT 1 FROM information_schema.table_constraints 
    WHERE table_name = 'xxpj_subscriptions' 
    AND constraint_name = 'xxpj_subscriptions_stripe_subscription_id_key'
  ) INTO constraint_exists;
  ...
  SELECT EXISTS (
    ...
    AND constraint_name = 'xxpj_usage_tracking_user_id_feature_type_reset_date_key'
  ) INTO constraint_exists;
  ...
  -- Check and add unique constraint on xxpj_usage.user_id
  SELECT EXISTS (
    SELECT 1 FROM information_schema.table_constraints 
    WHERE table_name = 'xxpj_usage' 
    AND constraint_name = 'unique_user_usage'
  ) INTO constraint_exists;
  ...
  SELECT EXISTS (
    SELECT 1 FROM information_schema.table_constraints 
    WHERE table_name = 'xxpj_feature_flags' 
    AND constraint_name = 'xxpj_feature_flags_flag_name_key'
  ) INTO constraint_exists;
  ...
  SELECT EXISTS (
    SELECT 1 FROM information_schema.table_constraints 
    WHERE table_name = 'xxpj_subscription_history' 
    AND constraint_name = 'xxpj_subscription_history_stripe_event_id_key'
  ) INTO constraint_exists;
