...
-- Add unique constraints using ALTER TABLE with exception handling
DO $$
BEGIN
...
-- Add unique constraint for usage tracking with exception handling
DO $$
BEGIN
  BEGIN
...
-- Add unique constraint for xxpj_usage with exception handling
DO $$
BEGIN
  BEGIN
...
-- Add unique constraint for feature flags with exception handling
DO $$
BEGIN
  BEGIN
...
-- Add unique constraint for subscription history with exception handling
DO $$
BEGIN
  BEGIN
