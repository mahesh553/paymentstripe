...
## Summary
This migration creates the complete database schema for the Resume Analyzer application with:
...
4. **Functions**
   - get_user_subscription_status: Get user subscription info
   - track_feature_usage: Track and limit feature usage
   - get_feature_limits: Get current usage limits
