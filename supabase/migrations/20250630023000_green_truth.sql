...
-- Add unique constraints using proper existence checks
DO $$
BEGIN
...
BEGIN
  ...
  FOR policy_record IN 
    ...
    AND tablename IN ('xxpj_users', 'xxpj_subscriptions', 'xxpj_usage', 'xxpj_usage_tracking', 'xxpj_feature_flags', 'xxpj_subscription_history', 'resumes', 'analyses', 'job_matches')
  LOOP
...
BEGIN
  -- Drop all existing triggers for the update function
